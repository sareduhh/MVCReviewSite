...
namespace MVCReviewSite.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,PublishedDate,Content,UserName,CategoryID")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,PublishedDate,Content,UserName,CategoryID")] Review review)
        {
            if (ModelState.IsValid)
            {
